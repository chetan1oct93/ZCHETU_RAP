...
define root view entity ZC_CHETU_TRAVEL_93
  provider contract transactional_query
  as projection on ZR_CHETU_TRAVEL_93

{
  key TravelUuid,
      ...
      _Booking : redirected to composition child ZC_CHETU_BOOKNG_93,
      _Attachment: redirected to composition child ZC_CHETU_ATTACH_93
}
